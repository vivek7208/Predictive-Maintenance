...
solution_prefix = cfn_stack_outputs.get('SolutionPrefix')
solution_bucket = cfn_stack_outputs.get('SolutionS3Bucket', default_bucket)
s3_prefix = cfn_stack_outputs.get('SolutionS3Prefix')
solution_name = cfn_stack_outputs.get('SolutionName')
solution_upstream_bucket = cfn_stack_outputs.get('SolutionUpstreamS3Bucket')
stack_name = cfn_stack_outputs.get('StackName')
library_version = cfn_stack_outputs.get('LibraryVersion')
